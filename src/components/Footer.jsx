...
export default function Footer() {
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-300">
      {/* Social Icons */}
      <div className="max-w-7xl mx-auto px-6 py-8 border-b border-gray-300 dark:border-gray-700">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="text-xs">
          ...
          <p className="mt-2">
            Address: Shop no 23, 3rd Floor, Satellite complex, Koppikar Rd, J C
            Nagar, New Hubli, Hubballi, Karnataka 580020
          </p>
